...
//  Hardware:
//  Das Beispiel ist für den Arduino Nano (!)
...
//  Christian Hammel, Sara Reichert & Julia Zimmermann, Technologiestiftung Berlin, 2019
...
static u1_t NWKSKEY[16] = {
    0xF2, 0x7F, 0x35, 0x64, 0xB4, 0x89, 0xB8, 0x09, 0x08, 0x12, 0x7D, 0xAC, 0x0F, 0xC6, 0xF1, 0x5C
    }; 
    
static u1_t APPSKEY[16] = {
    0xF2, 0x7B, 0x16, 0x81, 0x53, 0x70, 0x49, 0xBF, 0x24, 0xBD, 0x55, 0xB2, 0xB5, 0xF6, 0xCB, 0x46
    }; 
    
// ACHTUNG: DEVICE ADRESSE MIT PRÄFIX 0x
// *** Wert bekomt Ihr aus der TTN-Console,Format hex-Style! ***
static const u4_t DEVADDR = 0X26101GA2;  
...
// **** Alles ab hier ist Javascript --> nicht entkommentieren *****************
